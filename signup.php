<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        $sql = "SELECT Username FROM signup_page WHERE `Email Address` = '$Email'";
        $query = mysqli_query($conn, $sql);
        ...
        {
            $sql = "INSERT INTO `signup_page` (`First Name`, `Last Name`, `Username`, `Email Address`, `Password`, `Mobile`,`User_type`,`pfp`) VALUES ('$FirstName', '$LastName', '$Username', '$Email', '$Password', '$Mobile','Visitor',NULL);";
...
<head>
    ...
    <link href="signup.css?v=<?php echo time(); ?>" rel="stylesheet" type="text/css" />
</head>
<body>
    <script>
