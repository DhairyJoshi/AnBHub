        ...
        <section class="text-gray-600 body-font">
            <div class="container pb-20 pt-10 mx-auto px-32">
                <div class="flex flex-col text-center w-full mb-10">
                    <h2 class="text-5xl text-indigo-500 tracking-widest font-medium title-font mb-1">LIVE AUCTIONS</h2>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <button onclick="show1()">
                                    <span id="header1" class="inline-block py-2 px-2 rounded text-indigo-500 bg-indigo-100 text-xl font-medium tracking-widest mb-6 mr-6">CARS</span>
                                </button>
                                <button onclick="show2()">
                                    <span id="header2" class="inline-block py-2 px-2 rounded text-indigo-500 text-xl font-medium tracking-widest mb-6 mr-6">SHOES</span>
                                </button>
                                <button onclick="show3()">
                                    <span id="header3" class="inline-block py-2 px-2 rounded text-indigo-500 text-xl font-medium tracking-widest mb-6 mr-6">PAINTINGS</span>
                                </button>
                                <button onclick="show4()">
                                    <span id="header4" class="inline-block py-2 px-2 rounded text-indigo-500 text-xl font-medium tracking-widest mb-6 mr-6">ANTIQUES</span>
                                </button>
                                <button onclick="show5()"> 
                                    <span id="header5" class="inline-block py-2 px-2 rounded text-indigo-500 text-xl font-medium tracking-widest mb-6 mr-6">WATCHES</span>
                                </button>
                ...
                <div id="category1">
                    <?php
                        $sql1 = "SELECT * FROM products_live WHERE Category='Cars'";
                        ...
                        while ($i < $rows1)
                        {
                            $sql1 = "SELECT * FROM products_live WHERE Category='Cars' ORDER BY Date ASC";
                            $query1 = mysqli_query($conn, $sql1);
                                    ...
                                    <div class='sm:w-1/3 w-1/3 h-1/2 mb-10 px-4'>
                                        <div class='rounded-lg h-4/5 overflow-hidden border-2 border-gray-300'>
                                            <div class='w-12 flex-shrink-0 flex flex-col text-center leading-none absolute ml-3 py-3 px-2 bg-indigo-100'>
                                                <span class='text-indigo-500 pb-2 mb-2 border-b-2 border-indigo-200'>" . date ('M', strtotime ($rows[$key]['Date'])) . "</span>
                                                <span class='font-medium text-lg text-indigo-800 title-font leading-none'>" . date ('j', strtotime ($rows[$key]['Date'])) . "</span>
                                            </div>
                ...
                <div id="category2" class="hidden">
                    <?php
                        $sql1 = "SELECT * FROM products_live WHERE Category='Shoes'";
                        $query1 = mysqli_query($conn, $sql1);
                        ...
                        while ($i < $rows1)
                        {
                            $sql1 = "SELECT * FROM products_live WHERE Category='Shoes' ORDER BY Date ASC";
                            $query1 = mysqli_query($conn, $sql1);
                ...
                <div id="category3" class="hidden">
                    <?php
                        $sql1 = "SELECT * FROM products_live WHERE Category='Paintings'";
                        $query1 = mysqli_query($conn, $sql1);
                        ...
                        while ($i < $rows1)
                        {
                            $sql1 = "SELECT * FROM products_live WHERE Category='Paintings' ORDER BY Date ASC";
                            $query1 = mysqli_query($conn, $sql1);
                ...
                <div id="category4" class="hidden">
                    <?php
                        $sql1 = "SELECT * FROM products_live WHERE Category='Antiques'";
                        $query1 = mysqli_query($conn, $sql1);
                        ...
                        while ($i < $rows1)
                        {
                            $sql1 = "SELECT * FROM products_live WHERE Category='Antiques' ORDER BY Date ASC";
                            $query1 = mysqli_query($conn, $sql1);
                ...
                <div id="category5" class="hidden">
                    <?php
                        $sql1 = "SELECT * FROM products_live WHERE Category='Watches'";
                        $query1 = mysqli_query($conn, $sql1);
                        ...
                        while ($i < $rows1)
                        {
                            $sql1 = "SELECT * FROM products_live WHERE Category='Watches' ORDER BY Date ASC";
                            $query1 = mysqli_query($conn, $sql1);
