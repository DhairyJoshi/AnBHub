        ...
        <section class="text-gray-600 body-font">
            <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                ...
                <div class="lg:max-w-3xl lg:w-full md:w-1/2 w-5/6">
                    <img class="object-cover object-center rounded" alt="hero" src="./images/aboutus_image.jpg">
                </div>
            </div>
        </section>
        <section class="text-gray-600 body-font">
                ...
                <div class="flex flex-wrap -m-4">
                    <div class="p-4 lg:w-1/2">
                        <div
                            ...
                            <img alt="team"
                                ...
                                src="./images/profile pictures/pi_KRISH.png">
                    ...
                    <div class="p-4 lg:w-1/2">
                        <div
                            ...
                            <img alt="team"
                                class="flex-shrink-0 rounded-lg w-48 h-48 object-cover object-center sm:mb-0 mb-4"
                                src="./images/profile pictures/pi_SAMAY.png">
                            <div class="flex-grow sm:pl-8">
                    ...
                    <div class="p-4 lg:w-1/2">
                        <div
                            ...
                            <img alt="team"
                                class="flex-shrink-0 rounded-lg w-48 h-48 object-cover object-center sm:mb-0 mb-4"
                                src="./images/profile pictures/pi_DHAIRY.png">
                            <div class="flex-grow sm:pl-8">
                    ...
                    <div class="p-4 lg:w-1/2">
                        <div
                            ...
                            <img alt="team"
                                class="flex-shrink-0 rounded-lg w-48 h-48 object-cover object-center sm:mb-0 mb-4"
                                src="./images/profile pictures/pi_VIVEK.png">
                            <div class="flex-grow sm:pl-8">
                    ...
                    <div class="p-4 lg:w-1/2">
                        <div
                            ...
                            <img alt="team"
                                class="flex-shrink-0 rounded-lg w-48 h-48 object-cover object-center sm:mb-0 mb-4"
                                src="./images/profile pictures/pi_MANN.png">
                            <div class="flex-grow sm:pl-8">
                    ...
                    <div class="p-4 lg:w-1/2">
                        <div
                            ...
                            <img alt="team"
                                class="flex-shrink-0 rounded-lg w-48 h-48 object-cover object-center sm:mb-0 mb-4"
                                src="./images/profile pictures/pi_CHIRAG.png">
                            <div class="flex-grow sm:pl-8">
            ...
            <div class="container px-5 py-24 mx-auto">
                <div class="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
                    ...
                    <p class="leading-relaxed text-lg">AnB Hub is a website made for Selling and Buying products online
                        ...
                        almost all platforms including Windows, macOS, Android, Linux.All you need to connect with AnB
                        Hub is a browser and a internet connection and you are set to go. AnB Hub is made by students of
                        Government Polytechnic Ahmedabad, CE Dept and is free to use. You can get access to the website
                        by signing up or logging in if you've already signed up. The website is really interactive and
                        user friendly. You should definitely give it a try.</p>
